	...
	- #KAPITEL1 ^^15^^
		...
		- **OVERORDNEDE PRINCIPPER ****FOR ****PROBLEMBASERET ****LÆRING** ^^18^^
			...
			- **Virkelige og ****komplekse ****problemer der knytter teori ****til** **praksis** ^^20^^
				...
				- via denne forståelse, at broen mellem teori og praksis kan bygges, fordi problemet oftest springer ud af en praksis, der kræver nærmere teoretisk fundering og empirisk undersøgelse.
